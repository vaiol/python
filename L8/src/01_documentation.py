...
class Teacher(UniversityEmployee):
    ...
    def __init__(self,first_name: str,last_name: str,birth_date: date,salary: int,course: Course):
...
class Mentor(UniversityEmployee):
    ...
    def __init__(self, first_name: str,last_name: str,birth_date: date,salary: int,courses: List[Course]):
        super().__init__(first_name, last_name, birth_date, salary)
...
class University:
    ...
    def __init__(self, name: str, courses: List[Course], employees: List[UniversityEmployee], students: List[Student]):
        self.name = name
        self.courses = courses
